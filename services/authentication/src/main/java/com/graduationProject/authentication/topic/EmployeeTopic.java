...
public interface EmployeeTopic {
    //CREATE EMPLOYEE
    ...
    static final String CreateEmployeeSagaDone = "CreateEmployeeSagaDone"; //used by the participating services to give the orchestrator transaction status (publish)
